 ...
 */
public class AlternateRun3 implements Runnable {
     ...
     */
    public AlternateRun3(int threadcount,int firstnum) {
    ...
    class WorkThread extends Thread {
        ...
        @Override
        public void run() {
            for (int k = 0; k < 5; k++) //此处如果写while（currentindex<=75）会出现Thread1、Thread2多运行一趟的问题
				{
                try {
                    lock.lock();
